...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlite("DataSource=../AuthorizationServer/AuthDemoDb");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("OAuthScope");

                entity.HasIndex(e => e.OauthClientsId, "IX_OAuthScope_OAuthClientsId");

                entity.Property(e => e.OauthClientsId).HasColumnName("OAuthClientsId");

                entity.HasOne(d => d.OauthClients)
                    .WithMany(p => p.OauthScopes)
                    .HasForeignKey(d => d.OauthClientsId);
            });
